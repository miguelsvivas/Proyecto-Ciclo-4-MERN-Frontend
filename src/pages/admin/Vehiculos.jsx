...
const TablaVehiculos = ({ loading, listaVehiculos, setEjecutarConsulta }) => {
  ...
  return (
    <div className='flex flex-col items-center justify-center w-full'>
      ...
      />
      <h2 className='text-2xl font-extrabold text-gray-800'>Articulos</h2>
  ...
  const actualizarVehiculo = async () => {
    ...
    await editarVehiculo(
      vehiculo._id,
      {
        ...
        description: infoNuevoVehiculo.description,
        categoria: infoNuevoVehiculo.categoria,
        precio: infoNuevoVehiculo.precio,
        cantidad: infoNuevoVehiculo.cantidad,
        imagen: infoNuevoVehiculo.imagen,
      },
      (response) => {
        ...
        <>
          ...
          <td>
            <input
              className='bg-gray-50 border border-gray-600 p-2 rounded-lg m-2'
              type='text'
              value={infoNuevoVehiculo.description}
              onChange={(e) =>
                setInfoNuevoVehiculo({ ...infoNuevoVehiculo, description: e.target.value })
              }
            />
          </td>
          <td>
            <input
              className='bg-gray-50 border border-gray-600 p-2 rounded-lg m-2'
              type='text'
              value={infoNuevoVehiculo.categoria}
              onChange={(e) =>
                setInfoNuevoVehiculo({ ...infoNuevoVehiculo, categoria: e.target.value })
              }
            />
          </td>
          <td>
            <input
              ...
              onChange={(e) =>
                setInfoNuevoVehiculo({ ...infoNuevoVehiculo, precio: e.target.value })
              }
            />
          </td>
          <td>
            <input
              className='bg-gray-50 border border-gray-600 p-2 rounded-lg m-2'
              type='number'
              value={infoNuevoVehiculo.cantidad}
              onChange={(e) =>
                setInfoNuevoVehiculo({ ...infoNuevoVehiculo, cantidad: e.target.value })
              }
            />
          </td>
          <td>
            <input
              className='bg-gray-50 border border-gray-600 p-2 rounded-lg m-2'
              type='text'
              value={infoNuevoVehiculo.imagen}
              onChange={(e) =>
                setInfoNuevoVehiculo({ ...infoNuevoVehiculo, imagen: e.target.value })
              }
            />
          </td>
        </>
    ...
    await crearVehiculo(
      {
        ...
        description: nuevoVehiculo.description,
        categoria: nuevoVehiculo.categoria,
        precio: nuevoVehiculo.precio,
        cantidad: nuevoVehiculo.cantidad,
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      ...
      <form ref={form} onSubmit={submitForm} className='flex flex-col'>
        ...
        <label className='flex flex-col' htmlFor='imagen'>
          Imagen
          <input
            name='imagen'
            className='bg-gray-50 border border-gray-600 p-2 rounded-lg m-2'
